...
<template>
    <div class="text-center pt-5 bg-base-200 rounded-box h-full flex flex-col justify-between">
        <div>
            <h1>Big Title</h1>
            <div class="divider px-5"></div>
            <ul class="menu w-56 rounded-box pt-0">
                <li>
                    <RouterLink to="/Dashboard" @click="" class="">
        ...
        <div class="flex flex-col bg-base-200 rounded-box justify-between">


            <div class="divider px-5 mb-0"></div>
